...
//        findViewById(R.id.btn_segment).setOnClickListener(v ->
//                Toast.makeText(this, "功能待开发", Toast.LENGTH_SHORT).show());
    ...
    private void startCloudDetection() {
        ...
        // 启动NetworkStreamActivity
        Intent intent = new Intent(this, com.tencent.CloudDetect.NetworkStreamActivity.class);
    ...
    private void startDetection() {
        ...
        // 启动MainActivity
        startMainActivity(model, inputsize, hasCustomSettings);
    }
    /*** 显示参数信息*/
    ...
    /** * 启动MainActivity */
    private void startMainActivity(int model, int inputsize, boolean hasCustomSettings) {
